                ...
                <Navbar.Collapse id="basic-navbar-nav">
                   <img style={{width:"200px"}} src={logo} alt="" />
                    ...
                    <Link style={{textDecoration:'none',color:`${window.location.pathname==='/contack-us' ? '#ff4a57':'white'}`}} to={`/contack-us`}>
                          ...
                          <a href="https://drive.google.com/file/d/1xOBrA6GW643zV0tMHNCcuOz9zzgx71R6/view"><button class="btn btn-outline-danger text-white my-2 my-sm-0" type="submit">Resume</button> </a>
                    </Nav>
                </Navbar.Collapse>
            </Navbar>
        </div>
